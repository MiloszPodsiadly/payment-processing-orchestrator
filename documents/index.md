...
- `domain-model.md` - Phase 2 pure domain model, typed values, decision model, duplicate semantics, unknown outcomes, and implemented invariants.
- `payment-state-machine.md` - Phase 2 implemented payment states, legal commands, illegal commands, operation identity, unknown states, and corrupt-history behavior.
